...
function App() {
  ...
  return (
    <div className="pb-[70px] md:pb-[40px] flex flex-col mt-[15vh] md:mt-[12vh] relative bg-black"
      style={{ transition: "min-height 0.5s ease-in-out", minHeight: contentHeight || "auto" }}>
      ...
      <ImageCards
        images={slides.map((slide) => ({
          img: `${BaseUrl}/${slide.thumbnail}`,
          alt: slide.thumbnailAlt,
        }))}
        activeIndex={activeIndex}
        setActiveIndex={handleManualChange}
      />
    </div>
  );
}
